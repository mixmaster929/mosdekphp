<button id="backToTop" onclick="goToTop()" style="display:none; position:fixed; bottom:10px; right:10px; border:none; background-color:#73c019; color:white; width:50px; height:50px; border-radius:50%; cursor:pointer; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.25); text-align:center;">↑</button>
<div class="modal fade" id="buyTyreModal" tabindex="-1" role="dialog" aria-labelledby="buyTyreModalTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 10px;box-shadow: 2px 2px 3px rgb(255 255 255 / 22%); ">
            ...
            <div class="modal-body" style="overflow-x: hidden; ">
                <div class="alert alert-warning" role="alert" style="border-radius: 0; margin: -16px -16px 20px; padding: 5px 20px; font-size: 15px; background-color: white; color:black; ">
                    Vennligst full ut alle feltene nedenfor, og velg en tjeneste (valgfri)
                </div>

                <div class="priceContainer " style="position:initial; margin: 0 -16px 16px -16px; background: #333333;">
...
<div class="modal fade" id="locationinfoModal" tabindex="-1" role="dialog" aria-labelledby="locationinfoBuyModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="box-shadow: 2px 2px 6px rgb(251 128 0 / 57%);">
            <div class="modal-header" style="background-color: #333333;">
                <h5 class="modal-title">VENNLIGST TAST INN ADRESSE</h5>
            </div>
            <div class="modal-body">
...
function saveTime(time, timeID) {
    ...
    function showTimeSlots(date) {
        ...
        var locationID= '18'; //$('#locationID').val();
...
function saveService(serviceID, price, e) {
    ...
    $('#buyTyreModal').on('show.bs.modal', function (e) {
        ...
        var today = new Date();
        let tyreIDValue = parseInt(button.data('tyreid'));
        let tyreIDApiValue = parseInt(button.data('tyreidapi'));
        if (tyreIDValue == 0) {
            var tyreid = variables['tyreID'] = tyreIDApiValue;
            variables['apiTyre'] = 1;
        } else {
            var tyreid = variables['tyreID'] = tyreIDValue;
            variables['apiTyre'] = 0;
        }
    ...
    $('#continueButton').on('click', function() {
        console.log('buymodal continue button dekk' + $("#addressLocation").val());
        var emptyField = 0;
...
$("#regNr" ).change(function() {
    ...
    function showModalPopup() {
        ...
        $('#locationinfoModal.modal').css('background', '#000000c9'); // fade
...
// Funktion för att visa knappen när vissa villkor uppfylls
function showButton() {
    document.getElementById('backToTop').style.display = 'block';
}

// Ersätt den här delen med den logik som avgör när knappen ska visas
// Exempel: Om användaren scrollar ner mer än 1000px från toppen
window.addEventListener('scroll', function() {
    ...
    $(document).ready(function() {
        ...
        $("#regNr").val(regNrWarehouseModal).change();
