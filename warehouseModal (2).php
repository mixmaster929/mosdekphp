...
<div class="modal fade" id="warehouseModal" tabindex="-1" role="dialog" aria-labelledby="warehouseModalTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="">
            ...
            <div class="row" style="display: block;" id="additionalServiceDekkModal">
...
Hvis ikke det er valgt, må vi ta betalt 100.- ved dekkskiftet</span>
                ...
                <div class="modal-footer" id="footer-btn">
                    ...
                    <button type="button" class="btn btn-primary" id="continueButtonDekk">Fortsett</button>
                </div>
...
<div class="modal fade accordion" id="accordianModal" tabindex="-1" role="dialog" aria-labelledby="accordianModal" aria-hidden="true">
    <div class="modal-dialog" style="max-width:600px" role="document">
        <div class="modal-content" style="margin-top:100px; width:auto">
            ...
            <div class="section">
                <a class="section-title" href="#accordion-3">Avbalansering / Bytte dekk på felg</a>
        ...
        <div class="modal-content" style="">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group" style="margin-bottom:10px;">
                        <input type="text" class="form-control " id="carType" placeholder="Car Type">
                    </div>
                    <div class="form-group" style="margin-bottom:10px; display:none;">
...
$('#warehouseModal').on('show.bs.modal', function (e) {
    ...
    function onRegisterClick() {
        ...
        if(username == '' || password == '' || fullName == '' || regNr == '' || mobile == '' || postCode == '' || address == '' || city == '' || price == '' || carType == '' || delivery_date == '' || delivery_time == '' || tyreSize== '' || season == '') {
        ...
        showLoadingBar();
        var url = 'method=registerCustomer&email='+email+'&username='+username+'&password='+password+'&fullName='+fullName+'&regNr='+regNr+'&mobile='+mobile+'&postCode='+postCode+'&address='+address+'&city='+city+'&price='+price+'&carType='+carType+'&delivery_date='+delivery_date+'&delivery_time='+delivery_time+'&tyreSize='+tyreSize+'&season='+season;
        fetch(url, function(result) {
            hideLoadingBar();
            var e = JSON.parse(result);
            if(e[0] == 'success') {
    ...
    function onRegisterWithoutTyreClick() {
        ...
        if(username == '' || password == '' || fullName == '' || regNr == '' || mobile == '' || postCode == '' || address == '' || city == '' || price == '' || carType == '') {
            console.log(username, password,fullName,'1')
            console.log(regNr, mobile , postCode ,'2')
        ...
        showLoadingBar();
        var url = 'method=registerCustomerWithoutTyre&email='+email+'&username='+username+'&password='+password+'&fullName='+fullName+'&regNr='+regNr+'&mobile='+mobile+'&postCode='+postCode+'&address='+address+'&city='+city+'&price='+price+'&carType='+carType;
        fetch(url, function(result) {
            hideLoadingBar();
            var e = JSON.parse(result);
            if(e[0] == 'success') {
