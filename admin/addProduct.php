<?php
    ...
    if($_SESSION['superAdmin'] == 1){
        $location .= '<option value=Mutto>Mutto</option>';
    }
    $location .= '<option value="Moss Dekk AS">Moss Dekk AS</option>';
				...
				<div class="row">
					...
					<div class="form-group col-md-12 col-lg-6" style="">
						<div class="form-group" style="margin-bottom:10px;">
							<label for="mobile" class="col-form-label labelMod" style="width:300px;">Number of Size and Price(Kr):</label>
					...
					<div class="form-group col-md-12 col-lg-6" style="">
					    <div class="form-group" style="margin-bottom:10px;">
							<label for="mobile" class="col-form-label labelMod">Location:</label>
							<select class="form-control" id="locationInfo" name="locationInfo">
								<?php echo $location; ?>
							</select>
						</div>	
					</div>
