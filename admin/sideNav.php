...
<div class="col-sm-2 border-right px-0 h-100" style="margin-top:30px; position:fixed; height:100vh; background-color:#fff; width:220px;">
	...
	<div class="list-group list-group-flush text-left">
		...
		<a href="?p=norgesDekk" class="list-group-item list-group-item-action py-2">Norges Dekk</a>
		...
		<?php if($_SESSION['superAdmin'] == 1){echo '<a href="?p=addAdmin" class="list-group-item list-group-item-action py-2">Admins</a>';} ?>
		<a href="javascript:logout();" class="list-group-item list-group-item-action py-2">Logout</a>
		<a href="http://autobutler.no/management/code/" class="list-group-item list-group-item-action py-2">Autobutler Managment</a>
