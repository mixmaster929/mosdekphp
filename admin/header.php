...
if(isset($_POST['submit']) && ($_POST['username'] != '') && ($_POST['pass'] != '')) {
	...
	$q = mysqli_query($con, "SELECT * FROM shop_admins WHERE `username`='$username' AND `password`='$pass' and (location = 'Moss Dekk AS' or superAdmin=1)");
...
<body class="" style="background: white !important;">
