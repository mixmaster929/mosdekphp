    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="register2" onclick="onRegisterWithoutTyreClick()">Registrer som ny kunde</button>
            </div>
...
// 			$(this).css('border', '1px solid red');
    ...
    function tyreChangeDekkhotellOrder() {
        ...
        var locationID = '18';  //variablesDekk['locationID'] = $("#locationID").val();
    ...
    function tyreChangeOrderDekk() {
        ...
        fetch(url, function(result) {
            ...
            if(e[0] == 'failed') {
                ...
                showAlert('success', 'Bestillingen din er nå mottatt og registrert. Du vil snart få e-mail med bekreftelse.');
                $('.modal').modal('hide');
                window.location.href = "?p=successfulOrder&"+'locationID='+locationID+'&addressLocation='+addressLocation+'&postcodeLocation='+postcodeLocation+'&cityLocation='+cityLocation+'&method=tyreOrderWithoutLogin&paymentDone=0&dekk=1&orgNr='+orgNr+'&reference='+reference+'&paymentMode='+paymentMode+'&tyreID='+variablesDekk['tyreID']+'&ps=1&email='+email+'&totalTime='+variablesDekk['totalTime']+'&workType='+type+'&price='+variablesDekk['price']+'&regNr='+regNr+'&name='+name+'&mobile='+mobile+'&date='+date+'&serviceIDs='+variablesDekk['serviceIDs']+'&serviceCounts='+variablesDekk['serviceCounts']+'&time='+variablesDekk['time']+'&tyres='+tyres+servicesURL;
                variablesDekk = [];
                //location.reload(true);
            }
